...
Route::get('basic9',function(){
        return "Hello world";
})->name('basic9');

#route('basic9') ==>http://localhost/public/basic9
...
#http://localhost/public/Student/Class/info1
Route::get('Student/info1','Student\ClassController@info1');
